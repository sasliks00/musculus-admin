...
<?php
include "connect.php";
//Iegūst ID skaitli no aizpildītā lauciņa kas ir jāatrod
$idfromform = $_GET["id"];
//Meklē pēc ID un paņem visu nepieciešamo informāciju
...
if ($result->num_rows > 0) {
    //Attēlo informāciju par abonementu ar attiecīgo ID
  ...
  //Ja netiek atrasts abonements ar norādīto ID
    echo "<h1 class='text-danger text-center'><strong>Nav rezultātu, ievadījāt pareizu abonementa numuru?</strong></h1>
    <form action='/index.php' class='p-4 text-center'>
            <button name='submit' type='submit' class='btn btn-danger text-center'>Atgriezties</button>
            </div>
            </form> ";
}
//Pagarināt abonementa termiņu
$sql = "SELECT id, vards_uzvards, email, telefons, abonenta_veids, atlaide, termins, piezime FROM abonenti WHERE id LIKE '" . $idfromform . "'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
    // katras rindas informacija
    while($row = $result->fetch_assoc()) {
        ...
        <label class="col-sm-4 col-form-label text-white text-center" for="id">Abonementa ID:</label> 
        <div class="col-md-8">
        ...
        <input id="id" name="id" placeholder=' . $row["id"]. ' type="text" aria-describedby="idHelpBlock" required="required" class="form-control here">
         ...
         <span id="idHelpBlock" class="form-text text-white">Katram abonementam tiek izsniegta kluba karte un uz tās ir attiecīgā abonementa unikālais numurs</span>
                   ...
                   <div class="form-group row">
            <label for="example-url-input" class="col-sm-4 col-form-label text-center text-white">Abonementa termiņš:</label> 
            <div class="col-md-8">
              <div class="input-group">
                <div class="input-group-addon">
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <input id="id" name="id" placeholder=' . $row["id"]. ' type="text" aria-describedby="idHelpBlock" required="required" class="form-control here">
         ...
         <span id="idHelpBlock" class="form-text text-white">Katram abonementam tiek izsniegta kluba karte un uz tās ir attiecīgā abonementa unikālais numurs</span>
                   ...
                   <div class="form-group row">
            <label for="example-url-input" class="col-sm-4 col-form-label text-center text-white">Piezīme:</label> 
            <div class="col-md-8">
              <div class="input-group">
                <div class="input-group-addon">
    ...
    while($row = $result->fetch_assoc()) {
        ...
        <input id="id" name="id" placeholder=' . $row["id"]. ' type="text" aria-describedby="idHelpBlock" required="required" class="form-control here">
         ...
         <span id="idHelpBlock" class="form-text text-white">Katram abonementam tiek izsniegta kluba karte un uz tās ir attiecīgā abonementa unikālais numurs</span>
          ...
          <div class="form-group row">
            <label for="vardsuzvards" class="col-sm-4 col-form-label text-center text-white">Vārds Uzvārds:</label> 
            <div class="col-md-8">
              <div class="input-group">
                <div class="input-group-addon">
                  <i class="fa fa-address-card"></i>
          ...
          <div class="form-group row">
            <label for="email" class="col-sm-4 col-form-label text-center text-white">E-pasts:</label> 
            <div class="col-md-8">
              <div class="input-group">
                <div class="input-group-addon">
                  <i class="fa fa-at"></i>
          ...
          <div class="form-group row">
            <label for="telefons" class="col-sm-4 col-form-label text-center text-white">Telefons:</label> 
            <div class="col-md-8">
              <div class="input-group">
                <div class="input-group-addon">
          ...
          <div class="form-group row">
            <label class="col-sm-4 text-white text-center">Abonenta veids:</label> 
            <div class="col-md-8">
          ...
          <div class="form-group row">
            <label class="col-sm-4 text-white text-center">Students vai pensionārs:</label> 
            <div class="col-md-8">
              <label class="custom-control custom-radio">
