<?php
session_start();
//Pārbauda vai ir izveidota sesija
  if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] == false){
    //Ja nav tad tiek novirzīts uz "admin.php" lapu
...
<?php
include "connect.php";
//Iegūst ievadīto ID un jauno termiņa datumu
$idfromform = $_GET["id"];
$new_termins = $_GET["termins"];
//Aizvieto veco termiņu ar izvēlētu jauno
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo "<h1 class='text-danger text-center'><strong>Abonementa ID: " . $row["id"]. " termiņš pagarināts!</strong></h1><br>";
